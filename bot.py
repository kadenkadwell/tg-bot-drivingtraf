from aiogram import Bot, Dispatcher, types
  ...
  KEYWORDS = {
      'девушка': {'path': 'https://raw.githubusercontent.com/kadenkadwell/tg-bot-drivingtraf/refs/heads/main/mainphoto.webp', 'caption': 'Вот твой файл!'},
      'traffic2025': {
          'path': None,
  ...
  async def check_subscription(user_id: int) -> bool:
      ...
      try:
          ...
          logging.info(f"User {user_id} status: {member.status}")  # Добавляем отладочный лог
  ...
  async def start_command(message: types.Message):
      ...
      text = (
          ...
          "Например, попробуй тестовый промокод - девушка."
      )
